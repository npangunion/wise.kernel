...
namespace
{
std::vector<wise::tick_t> intervals{
	10,
	20,
	30,
	40,
...
int timer::set(tick_t interval, tick_t duration, bool repeat, tick_t after)
{
	...
	auto rp = wise_shared<req>(*this, seq_.next(), interval, duration, after, repeat);
