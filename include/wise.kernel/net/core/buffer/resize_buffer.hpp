...
#include <wise/net/detail/buffer/multiple_size_buffer_pool.hpp>
#include <wise/net/detail/buffer/resize_buffer_iterator.hpp>
...
public:
	...
	bool read(uint8_t* p, std::size_t len)
	{
		...
		::wise::memcpy((void*)p, len, data() + read_pos_, len);
