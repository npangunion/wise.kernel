...
* 'configure.py --amalgamation --minimized-build --enable-modules=aes --enable-modules=crc32 --enable-modules=sha1 --disable-cc-tests --cpu=x86 --msvc-runtime=MT --enable-static-library'
*
* Target
...
#define BOTAN_VERSION_VC_REVISION "git:8b83aac3c49908505b6e2cfa244f918868b5e297"
